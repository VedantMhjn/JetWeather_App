                ...
                if (isAlreadyFavList.isNullOrEmpty()) {
                    IconButton(onClick = {
                        ...
                        Icon(
                            ...
                            contentDescription = "Selected Favorite Icon",
                    ...
                    IconButton(onClick = {
                        ...
                        Icon(
                            ...
                            contentDescription = "Unselected Favorite Icon",
                            tint = Color.Red.copy(alpha = 0.6f)
                        )
                    }
                    ShowToast(context = context, showIt = showIt, msg = "Added to Favorites")
                }
            }
        },
...
fun ShowSettingDropDownMenu(showDialog: MutableState<Boolean>, navController: NavController) {
    ...
    Column(
        ...
        DropdownMenu(
            ...
            //No need for column cause this lambda's scope is columnScope
            items.forEachIndexed { index, text ->
                DropdownMenuItem(
                    ...
                    text = { Text(text = text,/* modifier = Modifier.clickable {
                        //expanded = false
